...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public class OdinGettingStartedWindow : OdinEditorWindow
    {
        ...
        private void DrawHeader()
        {
            ...
            {
                var licensee = OdinInspectorVersion.Licensee;

                GUI.Label(rect.AlignCenterY(45).AddY(20).AddX(80), new GUIContent("Licensed to " + licensee), SirenixGUIStyles.LeftAlignedGreyMiniLabel);
            }
