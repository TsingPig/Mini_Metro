...
namespace Sirenix.OdinInspector.Editor.Drawers
{
    ...
    public class TableListAttributeDrawer : OdinAttributeDrawer<TableListAttribute>
    {
        ...
        protected override void Initialize()
        {
            ...
            if (!string.IsNullOrEmpty(this.Attribute.AddAction))
            {
                var context = new ActionResolverContext();
                context.Property = this.Property;
                context.ResolvedString = this.Attribute.AddAction;
                context.NamedValues = new ActionResolvers.NamedValues();
                context.SyncRefParametersWithNamedValues = true;
                this.addAction = ActionResolver.GetFromContext(ref context);
            }
