...
namespace Sirenix.Utilities
{
    ...
    {
        public const string DefaultSirenixPluginPath = "Assets/ThirdPlugins/Sirenix/";
        ...
        static SirenixAssetPaths()
        {
            ...
            if (File.Exists("Assets/ThirdPlugins/Sirenix/Odin Inspector/Assets/Editor/" + LookupAssetName))
            {
                // Default:
            ...
            else
            {
                ...
                sb.AppendLine("- Odin was not found in it's default location: 'Assets/ThirdPlugins/Sirenix/'.");
