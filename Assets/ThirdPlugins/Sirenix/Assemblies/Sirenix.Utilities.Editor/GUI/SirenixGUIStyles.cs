            ...
            get
            {
                if (!listItemColorEven.HasValue)
                {
                    listItemColorEven = EditorGUIUtility.isProSkin ?
                        OdinInspector.Editor.GeneralDrawerConfig.Instance.ListItemColorEvenDarkSkin :
                        OdinInspector.Editor.GeneralDrawerConfig.Instance.ListItemColorEvenLightSkin;
            ...
            get
            {
                if (!listItemColorOdd.HasValue)
                {
                    listItemColorOdd = EditorGUIUtility.isProSkin ?
                        OdinInspector.Editor.GeneralDrawerConfig.Instance.ListItemColorOddDarkSkin :
                        OdinInspector.Editor.GeneralDrawerConfig.Instance.ListItemColorOddLightSkin;
