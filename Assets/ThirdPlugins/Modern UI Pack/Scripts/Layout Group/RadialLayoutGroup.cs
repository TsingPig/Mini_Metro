...
namespace Michsky.MUIP
{
    ...
    public class RadialLayoutGroup : LayoutGroup
    {
        ...
        { Clockwise = 0, Counterclockwise = 1, Bidirectional = 2 }
        ...
        { get { return refLayoutDir; } set { SetProperty(ref refLayoutDir, value); } }

        [SerializeField] private float refRadiusStart = 200;

        public float radiusStart
        { get { return refRadiusStart; } set { SetProperty(ref refRadiusStart, value); } }

        [SerializeField] private float refRadiusDelta;

        public float radiusDelta
        { get { return refRadiusDelta; } set { SetProperty(ref refRadiusDelta, value); } }

        [SerializeField] private float refRadiusRange;

        public float radiusRange
        { get { return refRadiusRange; } set { SetProperty(ref refRadiusRange, value); } }

        [SerializeField] private float refAngleDelta;

        public float angleDelta
        { get { return refAngleDelta; } set { SetProperty(ref refAngleDelta, value); } }

        [SerializeField] private float refAngleStart;

        public float angleStart
        { get { return refAngleStart; } set { SetProperty(ref refAngleStart, value); } }

        [SerializeField] private float refAngleCenter;

        public float angleCenter
        { get { return refAngleCenter; } set { SetProperty(ref refAngleCenter, value); } }

        [SerializeField] private float refAngleRange = 200;

        public float angleRange
        { get { return refAngleRange; } set { SetProperty(ref refAngleRange, value); } }

        [SerializeField] private bool refChildRotate = false;

        public bool childRotate
        { get { return refChildRotate; } set { SetProperty(ref refChildRotate, value); } }
